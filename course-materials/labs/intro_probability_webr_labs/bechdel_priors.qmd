...
prior_dist <- dbeta(x, alpha_prior, beta_prior)
posterior_dist <- dbeta(x, alpha_posterior, beta_posterior)
...
prior_dist <- dbeta(parameter_space, 2, 2)        # Example Beta(2,2) prior
posterior_dist <- dbeta(parameter_space, 9, 5)    # Example Beta(9,5) posterior after observing data

# Create a data frame for ggplot2
df <- data.frame(
  parameter_space = rep(x, 2),
