...
```webr-rvery optimistic, fig.align = "center", fig.height = 5}
...
:::{.callout-note collapse="true"}
## Compare with the classmate to your left
...
```{webr-r}
summarize_beta_binomial(alpha = 14, beta = 1, y = number_correct, n = total_questions)
```

```webr-rfig.align = "center", fig.height = 5}
plot_beta_binomial(alpha = 14, beta = 1, y = number_correct, n = total_questions)
```
...
```{webr-r}
summarize_beta_binomial(alpha = 1, beta = 1, y = number_correct, n = total_questions)
```

```{webr-rfig.align = "center", fig.height = 5}
plot_beta_binomial(alpha = 1, beta = 1, y = number_correct, n = total_questions)
```
...
```{webr-r}
summarize_beta_binomial(alpha = 4, beta = 11, y = number_correct, n = total_questions)
```

```{webr-rfig.align = "center", fig.height = 5}
plot_beta_binomial(alpha = 4, beta = 11, y = number_correct, n = total_questions)
```
...
```{webr-rfig.align = "center", fig.height = 5}
plot_beta_binomial(alpha = 140, beta = 10, y = number_correct, n = total_questions)
```
...
```{webr-r}
summarize_beta_binomial(alpha = your_alpha, beta = your_beta, y = number_correct, n = total_questions)
```

```{webr-rfig.align = "center", fig.height = 5}
plot_beta_binomial(alpha = your_alpha, beta = your_beta, y = number_correct, n = total_questions)
```
...
```{webr-rsimulated data, echo = FALSE}
set.seed(10)
...
```{webr-rdata from google form, echo = FALSE, message = FALSE, warning = FALSE}
