---
title: "Introducing Frequentist and Bayesian Inference through an Interactive Classification of Real and Satirical Headlines"
...
-   Introduce the Course Context (Bayesian and frequentist)
-   Introduce the Quiz
...
-   **Frequentist Goal:** Introduce the idea of hypothesis testing.
-   **Bayesian Goal:** Show how priors, data, and posteriors interact with a real example.

*Bayesian activity assumes prior R coding experience and familiarity with conditional probability
...
- How does this compare the the strategy of guessing randomly?
...
- Responses classified as positive, negative, neutral or suggesting improvement and then further coded using deductive and inductive themes.
...
-   Fun activity where students generate their own data and explore Frequentist and Bayesian thinking.
