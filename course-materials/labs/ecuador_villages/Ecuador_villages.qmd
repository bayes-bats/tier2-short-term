...
- Would it be useful to show simulated scenarios with a $\mu$ and $\sigma$ assumed?
- I noticed that in your example you replace the global mean $\mu$ with the explantory variable specific local mean $\mu_i$ (for temperature). Is this just specific to the bike data example?
