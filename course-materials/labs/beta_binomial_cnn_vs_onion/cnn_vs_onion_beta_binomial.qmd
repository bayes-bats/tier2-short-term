...
* See how beliefs change when we get new infromation
...
gridExtra::grid.arrange(optimist, unsure, pessimist, ncol = 3)
...
gridExtra::grid.arrange(optimist, unsure, pessimist, your_plot, ncol = 2)
